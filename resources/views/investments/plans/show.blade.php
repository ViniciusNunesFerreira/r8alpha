...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="space-y-6">
        ...
        <div class="glass-effect p-6 rounded-xl">
            ...
            <a href="https://chat.whatsapp.com/FgrnQYcPohr8tflTWenFV3?mode=hqrt3" class="flex items-center justify-center space-x-2 py-3 px-4 bg-white/10 hover:bg-white/20 rounded-lg transition">
